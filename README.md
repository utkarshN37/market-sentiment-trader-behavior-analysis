...
- Study changes in trading behavior during Fear and Greed periods.
- Segment traders based on trading characteristics.
- Generate business insights and trading recommendations from the analysis.
...
1. **Bitcoin Fear & Greed Index**
   - Daily market sentiment values and classifications.

2. **Hyperliquid Historical Trader Data**
   - Trade-level information including PnL, position size, trade direction, and timestamps.
...
- Adjust position sizes dynamically based on market sentiment.
- Focus on improving risk-reward ratio instead of maximizing win rate.
...
│
├── Market_Sentiment_Trader_Behavior_Analysis.ipynb
├── data/
├── README.md
└── requirements.txt
```
